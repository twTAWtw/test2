...
def test_sshpass_and_ssh():
    ...
    stream = os.popen('sshpass -p "cisco1234" ssh -o ProxyCommand="ssh -W %h:%p -q vlab-vpn" -l vradmin 172.17.0.9 "show platform"')
    output = stream.read()
    print(output)
    stream = os.popen('sshpass -p "cisco1234" ssh -o ProxyCommand="ssh -W %h:%p -q vlab-vpn" -l vradmin 172.17.0.9 "show version"')
    output = stream.read()
    print(output)
    stream = os.popen('sshpass -p "cisco1234" ssh -o ProxyCommand="ssh -W %h:%p -q vlab-vpn" -l vradmin 172.17.0.9 "show running-config"')
    output = stream.read()
    print(output)
    stream = os.popen('sshpass -p "cisco1234" ssh -o ProxyCommand="ssh -W %h:%p -q vlab-vpn" -l vradmin 172.17.0.9 "show users"')
    output = stream.read()
    print(output)
...
def test_pyATS():
    ...
    ios_xr.connect()
    print(ios_xr.execute('show platform'))
    print(ios_xr.execute('show version'))
    print(ios_xr.execute('show running-config'))
    print(ios_xr.execute('show users'))
    #ios_xr.disconnect()
